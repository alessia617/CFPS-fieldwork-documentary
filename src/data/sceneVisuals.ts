...
function src(base: string): string {
  const name = base.replace(/\.jpg$/, '')
  return `/assets/village/${name}_thumb.jpg 400w, /assets/village/${name}_med.jpg 800w, ${base} 1400w`
}
...
export const sceneVisuals: SceneVisual[] = [
  {
    ...
    imagePath: '/assets/village/scene_farmland.jpg', srcSet: src('/assets/village/scene_farmland.jpg'),
    filter: nprFar, mobileFilter: mFar,
  },
  {
    nodeId: 'shop',
    groundColor: '#bca888', mood: '有人气、日常、信息点', timeOfDay: '下午三点半 · 晴',
    imagePath: '/assets/village/scene_shop.jpg', srcSet: src('/assets/village/scene_shop.jpg'),
    filter: nprMid, mobileFilter: mMid,
  },
  {
    nodeId: 'committee',
    groundColor: '#c0ac90', mood: '冷清、正式、疏离', timeOfDay: '下午三点 · 薄云',
    imagePath: '/assets/village/scene_committee.jpg', srcSet: src('/assets/village/scene_committee.jpg'),
  ...
  },
  {
    ...
    imagePath: '/assets/village/scene_drying_field.jpg', srcSet: src('/assets/village/scene_drying_field.jpg'),
  ...
  },
  {
    ...
    imagePath: '/assets/village/scene_target_vicinity.jpg', srcSet: src('/assets/village/scene_target_vicinity.jpg'),
  ...
  },
  {
    ...
    imagePath: '/assets/village/scene_pond.jpg', srcSet: src('/assets/village/scene_pond.jpg'),
